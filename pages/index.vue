  ...
  <main>
    <section class="w-full px-6 pb-12 antialiased bg-white">
      <div class="mx-auto max-w-7xl">
        ...
        <!-- Main Hero Content -->
        <div
          class="container mt-20 max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center"
        >
          <h1
    ...
    <section class="bg-white">
      <div class="max-w-5xl px-6 py-16 mx-auto">
        <div
          class="px-8 py-12 bg-gray-800 rounded-md md:px-20 md:flex md:items-center md:justify-between"
        >
          <div>
            <h3 class="text-2xl font-semibold text-white">
              Interested to see how we began?
            </h3>
            <p class="max-w-md mt-4 text-gray-400">
              If you are interested to see how we began you can read the full
              story how we began the project.
            </p>
          </div>
...
export default Vue.extend({
  head() {
    return {
      title: "Ceres N Meses Website",
      description:
        "The Ceres N Meses MTs TechnoNatura Grade 7 Arduino project group website."
    };
  }
});
</script>
